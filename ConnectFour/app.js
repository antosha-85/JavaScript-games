document.addEventListener('DOMContentLoaded', ()=>{
    ...
    for (let i = 0; i < squares.length; i++) {
        (function(index) {
            ...
            squares[i].onclick = function () {
                //if the square below your current is taken, you can go on top of it
    ...
    function checkBoard() {
        ...
        for (let j = 0; j < winningArrays.length; j++) {
            ...
            console.log("checkBoard -> squares[winningArrays[j][0]]", squares[winningArrays[j][0]])
            console.log("checkBoard -> square1", square1)
            const square2 = squares[winningArrays[j][1]]
            console.log("checkBoard -> square2", square2)
    ...
    // add an eventListener to each square that will trigger the checkBoard funcion on click 
